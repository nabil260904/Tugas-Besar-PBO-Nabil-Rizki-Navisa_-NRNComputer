...
public class Config {
  ...
  private static final String DB_URL = "jdbc:mysql://localhost:3306/nrn_komputer";
  ...
  public static String getAllData()
  {
    ...
    try {
      ...
      while( resultData.next() ){
        data += String.format("|%-20s | %-20s | %-20s | %-20s | %-20s | %-20s | %-20s |\n",
        resultData.getInt("invoiceNumber"),
        resultData.getString("customerName"),
        resultData.getString("Contact"),
        resultData.getString("Address"),
        resultData.getString("itemName"),
        resultData.getDouble("price"),
